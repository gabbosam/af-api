...
var PDFDict = /** @class */ (function (_super) {
    ...
    PDFDict.prototype.lookupMaybe = function (key) {
        ...
        return (_a = this.context).lookupMaybe.apply(_a, tslib_1.__spreadArrays([this.get(key)], types));
    };
    PDFDict.prototype.lookup = function (key) {
        ...
        return (_a = this.context).lookup.apply(_a, tslib_1.__spreadArrays([this.get(key)], types));
    };
